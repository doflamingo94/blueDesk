...
const hydrateUser = async () => {
    try {
        const response = await axios.get(`https://13.39.156.186:3001/api/v1/candidats/${userId}`);
...
const candidatures = async () => {
    try {
        const response = await axios.post('https://13.39.156.186:3001/api/v1/candidats/candidatures', {
            id_candidat: userId
        });
...
const deleteCandidature = async (annonceId) => {
    try {
                const response = await axios.post('https://13.39.156.186:3001/api/v1/candidats/deleteCandidature', {
